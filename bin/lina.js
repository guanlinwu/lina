...
;(async () => {
  ...
  const argv = require('yargs')
    ...
    .example('lina pull view1 --git-alias=views-libs', 'pull the view1 module(packages) with repository alias: views-libs,lina is the default one if no this parameter')
